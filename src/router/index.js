...
const OrderList = () =>
  import('@/components/orderlist/OrderList')
const Feedback = () =>
...
const GetRecharge = () =>
  import('@/components/recharge/GetRecharge')
const Ticket = () =>
  import('@/components/ticket/Ticket')
const GetTicket = () =>
  import('@/components/ticket/GetTicket')
const Receipt = () =>
  import('@/components/receipt/Receipt')
const ReceiptHistory = () =>
  import('@/components/receipt/ReceiptHistory')
const PaymentHomepage = () =>
  import('@/components/payment/PaymentHomepage')
const PaymentInput = () =>
  import('@/components/payment/PaymentInput')
const Charging = () =>
  import('@/components/payment/Charging')
const Success = () =>
...
const ChooseCity = () =>
  import('@/components/chooseCity/ChooseCity')
const TerminalInfo = () =>
  import('@/components/terminal/TerminalInfo')
const ChargingMethod = () =>
  import('@/components/terminal/ChargingMethod')
const Infomation = () =>
  import('@/components/infomation/Infomation')
const nickname = () =>
  import('@/components/infomation/nickname')
const realname = () =>
  import('@/components/infomation/realname')
const carsinfo = () =>
